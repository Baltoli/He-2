...
void do_func_test(unsigned int input_image, unsigned int output_image){


	dimension_t * input_bounds = malloc(sizeof(dimension_t));
	input_bounds->dims = 3; input_bounds->width = 144; input_bounds->height = 120; input_bounds->colors = 3;

	dimension_t * output_bounds = malloc(sizeof(dimension_t));
	output_bounds->dims = 3; output_bounds->width = 144; output_bounds->height = 120; output_bounds->colors = 3;
